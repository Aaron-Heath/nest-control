...
public class ThermostatDeserializationTest {
    ...
    public void whenDeserializing_thenCorrect() throws JsonProcessingException {
        ...
        ThermostatTrait.AmbientHumidity expectedHumidity = new ThermostatTrait.AmbientHumidity();
        expectedHumidity.setAmbientHumidityPercent(53);

        ThermostatTrait.ThermostatConnection expectedConnection = new ThermostatTrait.ThermostatConnection("ONLINE");

        ThermostatTrait.ThermostatMode expectedMode = new ThermostatTrait.ThermostatMode();
        expectedMode.setAvailableModes(List.of("HEAT", "COOL", "HEATCOOL", "OFF"));
        expectedMode.setMode("COOL");

        ThermostatTrait.ThermostatEco expectedEco = new ThermostatTrait.ThermostatEco();
        ...
        ThermostatTrait.AmbientTemperatureCelsius expectedTemp = new ThermostatTrait.AmbientTemperatureCelsius();
        expectedTemp.setAmbientTemperatureCelsius(23.67999);

        ThermostatTrait.ThermostatHvac expectedHvac = new ThermostatTrait.ThermostatHvac("COOLING");
